...
const site = [
  ...
  { field: 'tagline', value: 'Website & Software Development · Since 2018' },
  ...
  { field: 'certifications', value: '8+ Years · Since 2018' },
  { field: 'headline', value: 'I help businesses fix websites, scrape data, and build software that works' },
  { field: 'bio_short', value: "I've been building websites and custom software for US and global clients since 2018 — 163+ projects, mostly repeat work and referrals." },
  { field: 'bio_long', value: "Eight years in, the work is still straightforward: understand what you need, build it properly, and hand it over with clear docs so you are not stuck for every small change. I review every project personally. Deep handles QA, Shushma runs people and outreach, and Vinay keeps larger builds on track." },
  ...
  { field: 'hero_overline', value: '8+ Years · Websites & Software' },
  { field: 'hero_status', value: '8+ years in business · Reply within 24h' },
  { field: 'selectivity_line', value: '8 years · 120+ clients · Founder-led on every project' },
  { field: 'standards', value: '8+ years experience|Founder reviews every build|US & UK time zones|Clear pricing upfront' },
  { field: 'hero_title_line1', value: 'Your website should' },
  { field: 'hero_title_line2', value: 'win customers, not lose them' },
  { field: 'intro', value: 'Founder-led studio since 2018 — websites, data scraping, and custom software for business owners who want someone accountable, not a faceless agency.' },
  { field: 'hero_services', value: 'Website Redesign | Mobile-First | Speed & SEO | WhatsApp Integration' },
  { field: 'hero_badge', value: '8+ Years · 163+ Projects' },
  { field: 'artist_philosophy', value: "I'd rather take a week longer and ship something solid than rush something you'll need fixed in a month." },
  { field: 'contact_quote', value: "I've been running this studio since 2018. If we take your project, you talk to real people — not a ticket queue — and get straight answers on timeline and cost." },
  { field: 'team_intro', value: 'A small core team we have worked with for years — founder-led development, QA, delivery, and HR. For bigger builds we bring in trusted specialists, not random freelancers.' },
  ...
  { field: 'seo_description', value: 'Founder-led development since 2018 — website modernization, data scraping, and custom software. 8+ years, 163+ projects. Based in India, serving US & global clients.' },
...
const transformations = [
  ...
  },
  {
    ...
    story: 'Generic template → professional look that matches their reputation. Clear practice areas and a simple contact form.',
...
const packages = [
  {
    ...
    description: 'Quick fixes when your site mostly works but looks dated or slow on phones.',
    most_popular: '',
    starting_from: 'yes',
  },
  {
    ...
    description: 'Full redesign for small businesses — the package most clients pick when their site needs a proper refresh, not just a patch.',
    most_popular: 'yes',
    starting_from: '',
  },
  {
    ...
    description: 'For businesses that want blog, analytics, and lead capture built in from day one.',
    most_popular: '',
    starting_from: '',
  },
];
...
const faq = [
  { question: 'How long has your team been in business?', answer: 'Since 2018 — about 8 years now. Most clients find us on Fiverr or through referrals. We have delivered 163+ projects across websites, data scraping, and custom software.' },
  { question: 'What is included in a website modernization project?', answer: 'A mobile-first site that loads fast and makes calling or booking easy. Hosting, SSL, and handoff included.' },
  { question: 'Is web data scraping legal and compliant?', answer: 'We collect publicly visible data only — no private logins. Every project starts with a scope review.' },
  { question: 'What does custom software development include?', answer: 'Web apps, mobile apps, bots, and tools built for your workflow when off-the-shelf products do not fit.' },
  { question: 'Price and timeline?', answer: 'Websites from $499 (Starter Refresh). Business modernization from $1,499. Scraping from ~$200. Custom software after discovery. Most web projects: 2–4 weeks.' },
...
const servicesHub = [
  {
    ...
    color: '#3B82F6',
    tagline: 'Modern sites that load fast and get you more calls',
...
const servicePackages = [
  ...
  { id: 'web-business', service_id: 'web-modernization', name: 'Business Modernization', price: 1499, price_label: 'USD', includes: 'Full visual redesign|Up to 5 pages|Mobile-first|Basic SEO|WhatsApp link|2 revision rounds', description: 'Full redesign — our most common pick for small businesses ready to look current online.', starting_from: '', most_popular: 'yes', emoji: '🏆', order: 2 },
...
const seo = [
  { slug: 'website-redesign-small-business', title: 'Small Business Website Redesign | Shubham Sunny', h1: 'Small Business Website Redesign', description: 'We redesign outdated small business websites for US owners. Mobile-friendly, fast, and built to convert visitors into customers.', keywords: 'small business website redesign, website makeover small business', featured_package_id: 'business-modern' },
  { slug: 'modernize-outdated-website', title: 'Modernize Your Outdated Website | Shubham Sunny', h1: 'Modernize Your Outdated Website', description: 'Turn your old website into a modern, trustworthy online presence. Plain English process, US timezone friendly.', keywords: 'modernize outdated website, old website redesign', featured_package_id: 'business-modern' },
  { slug: 'website-design-for-dentists', title: 'Website Design for Dentists | Shubham Sunny', h1: 'Website Design for Dentists', description: 'Professional dental website design that builds patient trust. Mobile-first, easy booking, clear contact options.', keywords: 'dental website design, dentist website redesign', featured_package_id: 'growth-site' },
  { slug: 'restaurant-website-redesign', title: 'Restaurant Website Redesign | Shubham Sunny', h1: 'Restaurant Website Redesign', description: 'Modern restaurant websites with menus, hours, and click-to-call. Help hungry customers find and contact you.', keywords: 'restaurant website redesign, food business website', featured_package_id: 'starter-refresh' },
  { slug: 'professional-services-website', title: 'Professional Services Website | Shubham Sunny', h1: 'Websites for Professional Services', description: 'Professional websites for lawyers, consultants, and service businesses. Look credible, get more inquiries.', keywords: 'professional services website, law firm website design', featured_package_id: 'growth-site' },
];
...
const blog = [
  ...
  { slug: 'why-we-do-not-take-every-project', title: "What It's Like Working With Us", excerpt: "Eight years and 163+ projects in — here's how we actually work, from first message to handoff.", status: 'published', publish_date: '2026-06-22' },
